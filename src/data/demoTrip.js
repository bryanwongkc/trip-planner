...
function flightItem({ dayId, endTime, flightCode, id, order, startTime, title }) {
  return {
    ...
    description: 'Sample flight details for planning.',
    bookingRef: '',
    flightCode,
    locationName: '',
    address: '',
    ...
    overrides: {
      ...
      items: {
        ...
        [`${tripId}-dinner-tokyo-tower`]: {
          ...
          endTimeMode: 'time',
          durationMinutes: null,
          description: 'Arrival-night dinner placeholder.',
          bookingRef: '',
          status: 'considering',
      ...
      bookingOptions: {
        [`${tripId}-meal-booking-active`]: {
          ...
          cancellationPolicy: 'Primary lunch booking.',
          provider: '',
          startDate: '',
          endDate: '',
          price: null,
        ...
        [`${tripId}-meal-booking-backup`]: {
          ...
          cancellationPolicy: 'Backup lunch booking; cancel if unused.',
          provider: '',
          startDate: '',
          endDate: '',
          price: null,
